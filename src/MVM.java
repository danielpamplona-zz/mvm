    ...
    public static void codificador(short mem[], /* String sArquivo, */ short shPosicao, ArrayList<String> arrayInstrucoes) throws FileNotFoundException, IOException {
        ...
        for (final String sInstrucao : arrayInstrucoes) {
            ...
            if (sConteudo.equals("initax")) {// "init ax"
                ...
                mem[iMem++] = (short) (Short.parseShort(sAux) + shPosicao);
            } else if (sConteudo.contains("move[") && sConteudo.contains("],bx") && !sConteudo.contains("ax") && !sConteudo.contains("bp")) {
                twoByte = true;
                mem[iMem++] = 54;
                iPosConteudo = 5;
                String sAux = "";
                ...
                mem[iMem++] = (short) (Short.parseShort(sAux) + shPosicao);
            } else if (sConteudo.contains("move[") && sConteudo.contains("],ax") && !sConteudo.contains("bx") && !sConteudo.contains("bp")) {
                twoByte = true;
                mem[iMem++] = 9;
                iPosConteudo = 5;
                String sAux = "";
